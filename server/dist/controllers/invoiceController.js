...
exports.deleteInvoice = exports.sendPayPalInvoice = exports.getInvoices = exports.createStripeInvoice = exports.generateInvoice = void 0;
...
exports.createStripeInvoice = createStripeInvoice;
...
const sendPayPalInvoice = async (req, res) => {
    ...
    try {
        ...
        // 1. Create Draft
        const draft = await (0, paypalService_1.createPayPalInvoice)(ppData);
        // 2. Send
        await (0, paypalService_1.sendPayPalInvoiceByKey)(draft.id);
        // 3. Get Details (for link)
        const details = await (0, paypalService_1.getPayPalInvoice)(draft.id);
...
exports.sendPayPalInvoice = sendPayPalInvoice;
